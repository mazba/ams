                                                                    ...
                                                                    <div class="cont">
                                                                        ...
                                                                        <div class="cont-col2">
                                                                            <div class="desc">
                                                                                ...
                                                                                <span class="btn label label-sm label-primary user_info" data-user_id="<?php echo $ticket_issue['user_id'];?>"data-toggle="modal" data-target="#myModal" title="<?php echo $this->lang->line('NAME');?>"><?php echo $ticket_issue['name_bn'];?></span>
