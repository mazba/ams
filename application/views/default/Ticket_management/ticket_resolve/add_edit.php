                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body form">
                        <form id="system_save_form"
                              action="<?php echo $CI->get_encoded_url('ticket_management/ticket_resolve/index/save'); ?>"
                              method="post">
                            <input type="hidden" name="id" value="<?php echo $ticket['id']; ?>"/>
                            <input type="hidden" name="system_save_new_status" id="system_save_new_status" value="0"/>
                            <input type="hidden" name="comment[ticket_issue_id]"
                                   value="<?php echo $ticket['ticket_issue_id']; ?>"/>

                            <div class="form-body">
                                <div class="form-group has-error row">
                                    <div class="col-lg-2"><label class="control-label bold"
                                                                 for="name_bn"><?php echo $CI->lang->line('RESOLVER_NAME'); ?></label>
                                    </div>
                                    <div class="col-lg-8">
                                        <button class="btn btn-circle btn-danger btn-sm"
                                                type="button"><?php echo $users[0]['text']; ?></button>
                                    </div>
                                </div>
                                <div class="portlet light tasks-widget">
                                    <div class="portlet-body">
                                        <div class="task-content">
                                            <div data-handle-color="#D7DCE2" data-rail-visible1="0"
                                                 data-always-visible="1" class="" data-initialized="1">
                                                <ul class="feeds">
                                                    <?php
                                                    //$ticket_issues='';
                                                    if (empty($ticket_issues))
                                                    {
                                                        ...
                                                        <li>
                                                            <div class="task-title text-center">
                                                                <span
                                                                    class="label label-sm label-danger"><?php echo $CI->lang->line('DATA_NOT_FOUND'); ?></span>
                                                                ...
                                                                <div class="col1">
                                                                    <div class="cont">
                                                                        ...
                                                                        <div class="cont-col2">
                                                                            <div class="desc">
                                                                                <span class="h4"
                                                                                      title="<?php echo $this->lang->line('SUBJECT'); ?>"><?php echo $ticket_issue['subject']; ?></span>
                                                                                <br/>
                                                                                <br/>
                                                                        ...
                                                                        <div class="cont-col2 text-right">
                                                                            ...
                                                                            <span class="badge badge-warning"
                                                                                  title="<?php echo $this->lang->line('TOKEN'); ?>"><?php echo System_helper::Get_Eng_to_Bng($ticket_issue['ticket_issue_id']); ?></span>
                                                                            <?php
                                                                            $all_priority = $CI->config->item('ticket_priority');
                                                                            ?>
                                                                            <span class="badge badge-info"
                                                                                  title="<?php echo $this->lang->line('PRIORITY'); ?>"><?php echo isset($all_priority[$ticket_issue['priority']]) ? $all_priority[$ticket_issue['priority']] : ''; ?></span>
                                                                            <?php

                                                                            if (!empty($ticket_issue['issue_attachment'])) {
                                                                                ?>
                                                                                <a target="_blank"
                                                                                   href="<?php echo base_url() . $directory['ticket_issue'] . '/' . $ticket_issue['issue_attachment']; ?>"
                                                                                   class="badge badge-warning external"
                                                                                   title="<?php echo $this->lang->line('ATTACHMENT'); ?>"><?php echo $this->lang->line('ATTACHMENT'); ?></a>
                                                                                <?php
                                                                            }
                                                                            ?>
                                    ...
                                    if ($ticket_issue_status == $this->config->item('STATUS_ASSIGN'))
                                    {
                                        if ($user->user_group_level == $this->config->item('SUPPORT_GROUP_ID'))
                                        {
                                            ...
                                            <div class="form-group has-error row">
                                                <div class="col-lg-2"><label class="control-label bold"
                                                                             for="name_bn"><?php echo $CI->lang->line('RESOLVE_REMARKS'); ?></label>
                                                </div>
                                                <div class="col-lg-8">
                                                    <textarea name="comment[comment]" class="form-control"
                                                              rows="3"></textarea>
                                                </div>
                                            </div>
                                            <?php
                                        ...
                                        if ($ticket_issue_status == $this->config->item('STATUS_RESOLVE')) {
                                            ...
                                            <div class="col-lg-12 text-center h3">
                                                <button class="btn btn-circle btn-primary btn-large"
                                                        type="button"><?php echo $this->lang->line('RESOLVE'); ?></button>
                                            </div>
                                            <?php
                                        } else {
                                            ?>
                                            <div class="col-lg-12 text-center h3">
                                                <button class="btn btn-circle btn-danger btn-large"
                                                        type="button"><?php echo $this->lang->line('REJECT'); ?></button>
                                            </div>
                                            <?php
                                        }
                                    }
                                        ...
                                        <div class="portlet">
                                            ...
                                            <div id="chats" class="portlet-body">
                                                <div class="scroller "
                                                    ...
                                                    <div data-rail-visible1="1" data-always-visible="1"
                                                         style="height: 300px; overflow: scroll; width: auto;"
                                                         class="scroller" data-initialized="1">
                                                        <ul class="chats">
                                                            <?php
                                                            foreach ($comments as $comment) {
                                                                ...
                                                                <li class="<?php echo $in_out_class; ?>">
                                                                    <img
                                                                        src="<?php echo base_url(); ?>images/<?php echo $comment['picture_name'] ? 'users/' . $comment['picture_name'] : 'profile.png'; ?>"
                                                                        alt="" class="avatar">
                                                                    ...
                                                                    <div class="message">
                                                                        ...
                                                                        <a class="name" href="#">
                                                                            ...
                                                                            <span class="datetime">
                                                                                ...
                                                                                if (!empty($comment['resolve_status'])) {
                                                                                    ?>
                                                                                    <span class="badge badge-warning"
                                                                                          title="<?php echo $this->lang->line('TOKEN'); ?>">
                                                                        ...
                                                                        <span
                                                                            class="body"><?php echo $comment['comment']; ?></span>
                                                                    </div>
                                                                </li>
                                                                <?php
                                                            }
