...
<form id="system_save_form" action="<?php echo $CI->get_encoded_url('asset_management/product/index/save'); ?>"
      method="post">
...
<div class="col-md-6">
    <div class="form-group has-error row">
        ...
        <div class="col-lg-8">
            <input type="text" id="product_name" name="product[product_name]" value="<?php echo $product['product_name']; ?>"
                   placeholder="<?php echo $CI->lang->line('NAME'); ?>" class="form-control">
        </div>
    </div>
    ...
    <div class="form-group has-error row">
        ...
        <div class="col-lg-8">
            <input type="text" name="product[unit_price]" value="<?php echo $product['unit_price']; ?>"
                   placeholder="<?php echo $CI->lang->line('UNIT_PRICE'); ?>" class="form-control">
        </div>
    </div>
    <div class="form-group has-error row">
    ...
    <div class="form-group has-error row">
        <div class="col-lg-4"><label class="control-label bold"><?php echo $CI->lang->line('WAREHOUSE'); ?></label>
        </div>
        <div class="col-lg-8">
    ...
    <div class="form-group has-success row">
        ...
        <div class="col-lg-8">
            <input type="text" name="product[item_unit]" value="<?php echo $product['item_unit']; ?>"
                   placeholder="<?php echo $CI->lang->line('ITEM_UNIT'); ?>" class="form-control">
        </div>
    </div>
    <div class="form-group has-success row">
        <div class="col-lg-4">
        ...
        <div class="col-lg-8">
            <input type="text" name="product[sort_description]" value="<?php echo $product['sort_description']; ?>"
                   placeholder="<?php echo $CI->lang->line('SORT_DESCRIPTION'); ?>" class="form-control">
        </div>
    </div>
    <div class="form-group has-success row">
        <div class="col-lg-4">
        ...
        <div class="col-lg-8">
            <input type="text" name="product[specification]" value="<?php echo $product['specification']; ?>"
                   placeholder="<?php echo $CI->lang->line('SPECIFICATION'); ?>" class="form-control">
        </div>
    </div>
    <div class="form-group has-success row">
        <div class="col-lg-4">
        ...
        <div class="col-lg-8">
            <input type="text" name="product[model_no]" value="<?php echo $product['model_no']; ?>"
                   placeholder="<?php echo $CI->lang->line('MODEL_NO'); ?>" class="form-control">
        </div>
    </div>
    <div class="form-group has-success row">
        <div class="col-lg-4">
        ...
        <div class="col-lg-8">
            <input type="text" name="product[stock_book_no]" value="<?php echo $product['stock_book_no']; ?>"
                   placeholder="<?php echo $CI->lang->line('STOCK_BOOK_NO'); ?>" class="form-control">
        </div>
    </div>
    <div class="form-group has-success row">
        <div class="col-lg-4">
...
<div class="col-md-6">
    <div class="form-group has-success row">
        ...
        <div class="col-lg-8">
            <input type="text" name="product[warranty_start_date]"
                   ...
                   placeholder="<?php echo $CI->lang->line('WARRANTY_START_DATE'); ?>" class="form-control date-picker">
        </div>
    </div>
    <div class="form-group has-success row">
        <div class="col-lg-4">
        ...
        <div class="col-lg-8">
            <input type="text" name="product[warranty_end_date]"
                   ...
                   placeholder="<?php echo $CI->lang->line('WARRANTY_END_DATE'); ?>" class="form-control date-picker">
        </div>
    </div>
    <div class="form-group has-success row">
        <div class="col-lg-4">
        ...
        <div class="col-lg-8">
            <input type="text" name="product[purchase_order_no]" value="<?php echo $product['purchase_order_no']; ?>"
                   placeholder="<?php echo $CI->lang->line('PURCHASE_ORDER_NO'); ?>" class="form-control">
        </div>
    </div>
    <div class="form-group has-success row">
        <div class="col-lg-4">
        ...
        <div class="col-lg-8">
            <input type="text" name="product[purchase_date]"
                   ...
                   placeholder="<?php echo $CI->lang->line('PURCHASE_DATE'); ?>" class="form-control date-picker">
        </div>
    </div>
    <div class="form-group has-success row">
        <div class="col-lg-4">
    ...
    <div class="form-group has-error row">
        <div class="col-lg-4"><label class="control-label bold"><?php echo $CI->lang->line('MANUFACTURE'); ?></label>
        </div>
        <div class="col-lg-8">
    ...
    <div class="form-group has-success row">
        <div class="col-lg-4"><label class="control-label bold"><?php echo $CI->lang->line('CONDITION'); ?></label>
        </div>
        <div class="col-lg-8">
    ...
    if (!$product['id']) {
        ...
        <div class="col-md-4">
            <div class="form-group has-error row">
                ...
                <div class="col-lg-8">
                    <input type="number" id="number_of_product" value="" placeholder="Number Of Product"
                           class="form-control">
                </div>
            </div>
        </div>
                ...
                <div class="form-group has-error row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" name="product[product_code][]"
                               ...
                               placeholder="<?php echo $CI->lang->line('CODE'); ?>" class="form-control">
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group has-error row">
                    ...
                    <div class="col-lg-8">
                        <input type="text" name="product[serial_number][]"
                               ...
                               placeholder="<?php echo $CI->lang->line('SERIAL_NUMBER'); ?>" class="form-control">
                    </div>
                </div>
            </div>
        </div>
