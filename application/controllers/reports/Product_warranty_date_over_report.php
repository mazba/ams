...
class Product_warranty_date_over_report extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        ...
        $this->controller_url='reports/Product_warranty_date_over_report';
    ...
    private function system_list()
    {
        if($this->permissions['list'])
        {
            ...
            $ajax['status']=true;
            $ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("reports/product_warranty_date_over_reports/list",$data,true));

            if($this->message)
            {
                $ajax['system_message']=$this->message;
            }
            $ajax['system_page_url']=$this->get_encoded_url('reports/Product_warranty_date_over_report');
            $ajax['system_page_title']=$this->lang->line("PRODUCT_WARRANTY_DATE_OVER_REPORT");
