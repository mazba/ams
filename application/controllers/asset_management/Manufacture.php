...
class Manufacture extends Root_Controller
{
    public $permissions;
    public $message;
    ...
    function __construct()
    {
        ...
        $this->controller_url='asset_management/Manufacture';
        $this->load->model("asset_management/Manufacture_model");
    ...
    private function system_list()
    {
        if($this->permissions['list'])
        {
            ...
            $ajax['status']=true;
            $ajax['system_content'][]=array("id"=>"#system_wrapper","html"=>$this->load_view("asset_management/manufacture/list","",true));

            if($this->message)
            {
                $ajax['system_message']=$this->message;
            }
            $ajax['system_page_url']=$this->get_encoded_url('asset_management/manufacture');
            $ajax['system_page_title']=$this->lang->line("MANUFACTURE");
    ...
    private function system_add()
    {
        ...
        if($this->permissions['add'])
        {
            ...
            $data['title']=$this->lang->line("CREATE_NEW_MANUFACTURE");

            $data['manufacture'] = array
            (
                'id'=>'',
                'manufacture_name'=>'',
                'manufacture_code'=>'',
            ...
            $ajax['system_page_title']=$this->lang->line("ADD_MANUFACTURE");
            $ajax['system_page_url']=$this->get_encoded_url('asset_management/manufacture/index/add');
            $this->jsonReturn($ajax);
        }
        else
        {
